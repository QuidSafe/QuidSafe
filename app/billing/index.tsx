      ...
      <SafeAreaView style={styles.container} edges={['top']}>
        <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
          <Pressable onPress={() => router.back()} style={styles.backButton}>
            <FontAwesome name="arrow-left" size={16} color={Colors.light.text} />
          </Pressable>
          ...
          <Card>
            <View style={styles.activeRow}>
              ...
              <Text style={styles.planName}>{status?.plan === 'pro_annual' ? 'Annual' : 'Monthly'}</Text>
            </View>
            {status?.trialEndsAt && (
          ...
          <Pressable style={({ pressed }) => [styles.manageButton, pressed && styles.pressed]} onPress={handleManage}>
            {loading ? (
...
const styles = StyleSheet.create({
  ...
  backButton: { width: 40, height: 40, borderRadius: 20, backgroundColor: Colors.white, alignItems: 'center', justifyContent: 'center', ...Shadows.soft },
  header: { marginTop: Spacing.sm },
  title: { fontFamily: 'PlayfairDisplay_700Bold', fontSize: 28, color: Colors.primary },
  subtitle: { fontFamily: 'Manrope_400Regular', fontSize: 15, color: Colors.light.textSecondary, marginTop: Spacing.xs, lineHeight: 22 },

  plans: { flexDirection: 'row', gap: Spacing.sm },
  planCard: { flex: 1, backgroundColor: Colors.white, borderRadius: BorderRadius.card, padding: Spacing.md, borderWidth: 2, borderColor: Colors.light.border, ...Shadows.soft },
  ...
  planCardName: { fontFamily: 'Manrope_600SemiBold', fontSize: 15, color: Colors.light.text },
  ...
  interval: { fontFamily: 'Manrope_400Regular', fontSize: 13, color: Colors.light.textSecondary, marginLeft: 2 },
  planDesc: { fontFamily: 'Manrope_400Regular', fontSize: 12, color: Colors.light.textSecondary, marginTop: Spacing.xs },
