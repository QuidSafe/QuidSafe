    ...
    <SafeAreaView style={[styles.container, { backgroundColor: colors.background }]} edges={['top']}>
      <ScrollView contentContainerStyle={styles.scroll} showsVerticalScrollIndicator={false}>
        ...
        <Section title="5. Subscription Terms">
          <Paragraph>
            QuidSafe offers a 30-day free trial followed by a Pro subscription plan with full access to all features.
          </Paragraph>
          <BulletList
            items={[
              ...
              'Free trial: all new users receive a 30-day free trial with full access to all Pro features. No credit card is required to start the trial.',
